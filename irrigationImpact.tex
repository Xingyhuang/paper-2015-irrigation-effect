...
Hot spell features related with heat extremes are tabulated in Table \ref{tab:table4} for simulations and the UW dataset (results from PRISM were effectively equivalent to UW). Although hot spells were too long and too frequent without irrigation, once irrigation was enabled, length, duration and intensity were closely matched to UW by the model (differences were not statistically significant at the 95\% level). Notably, the cooling effect associated with irrigation led to a reduction in length and frequency of hot spells for about 20$\%$ and 30$\%$ (statistically significant at the 95\% level). The difference in Tmax between IRG and NRG runs when averaged over hot spells, compared with the seasonal average, was approximately half (but still significant). Therefore, it appears that irrigation had less impact on the temperature of hot days, compared with average summer days (also observed by \citet{lobell2008irrigation}). 

...
(add the this to the increase of precipitation; the cloud over CV in SON and DJF has increased, globally the total cloud cover or low-level cloud has increased 1$\%$ to 0.1$\%$. across different seasons.)
%PRECC, PRECL
...
\begin{table}
\begin{center}
\caption{RMSD, MSD and Corr of T$_{max}$ between models and observations over CV in JJA from 1980-2005.} \label{tab:table1}
...
\begin{table}
\begin{center}
\caption{Values of multiple variables over CV from models in JJA from 1980-2005.} \label{tab:table2}
\begin{tabular*}{7.5in}{l @{\extracolsep{\fill}}cccccccccccc}
...
\begin{table}
\begin{center}
\caption{The mean hot spell features for models and UW observation over CV in JJA from 1980-2005.} \label{tab:table4}
